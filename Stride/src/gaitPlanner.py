...
class trotGait:
    ...
    def stepTrajectory(
        self, phi, V, angle, Wrot, centerToFoot, stepOffset=0.75
    ):  # phi belong [0,1), angles in degrees
        if phi >= 1:
            phi = phi - 1.0
        # step describes a circuference in order to rotate
