...
def generate_launch_description():
    ...
    declare_lrCheckTresh_cmd = DeclareLaunchArgument(
        ...
        description='LR Threshold is the threshold of how much off the disparity on the l->r and r->l')
    ...
    mobilenet_tracker_node = launch_ros.actions.Node(
        package='depthai_examples', executable='mobilenet_tracker_node',
        output='screen',
    ...
    ld.add_action(mobilenet_tracker_node)
