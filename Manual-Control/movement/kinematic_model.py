...
class RobotKinematics:
    ...
    def solve(self, orn, pos, bodytoFeet):
        ...
        _FLcoord[0] = -_FLcoord[0]
        _BLcoord[0] = -_BLcoord[0]

        #        print(_FRcoord,_BRcoord)
        FR_angles, v0 = IK_solver.solveFR(_FRcoord, self.coxa, self.femur, self.tibia)
        FL_angles, v1 = IK_solver.solveFL(_FLcoord, self.coxa, self.femur, self.tibia)
        BR_angles, v2 = IK_solver.solveBR(_BRcoord, self.coxa, self.femur, self.tibia)
        BL_angles, v3 = IK_solver.solveBL(_BLcoord, self.coxa, self.femur, self.tibia)
        ...
        return FR_angles, FL_angles, BR_angles, BL_angles, v0, v1, v2, v3, _bodytofeet